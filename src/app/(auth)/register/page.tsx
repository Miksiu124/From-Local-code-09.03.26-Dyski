...
import { Mail, Lock, Eye, EyeOff, User, Loader2, UserPlus, Gift } from "lucide-react";
import { getRefCookie } from "@/lib/referral-cookie";
          ...
          <CardHeader className="text-center pb-2">
            ...
            {refCode && (
              <motion.div
                ...
                className="mt-2 inline-flex items-center gap-1.5 rounded-full bg-primary/10 border border-primary/20 px-3 py-1 text-xs font-medium text-primary"
              >
