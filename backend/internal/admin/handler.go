...
var allowedSettingsKeys = map[string]bool{
	...
	"custom_order_price_main_private":     true,
	"custom_order_price_main_public":      true,
	"custom_order_price_main_ppv_private": true,
	"custom_order_price_main_ppv_public":  true,
}
