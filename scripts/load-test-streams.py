...
Użycie:
  ...
  4. Uruchom:
     python scripts/load-test-streams.py --cookie "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..EV8QlRZmoaDf9f37oJKWyXQE__QGhBlczVPlFfHTmu8" --content-id "UUID" --streams 100 --duration 60
